	...
	return (
		<div className="w-[500px] max-w-full mx-auto mt-10 border rounded-md p-3">
			...
			<form onSubmit={handleSubmit(handleRegister)}>
				...
				{/* Username */}
				<div className="mt-3">
					<input {...register("username")} type="text" placeholder="Username" className="w-full border rounded-md p-2" />
				</div>
				...
				{/* Confirm password */}
				<div className="mt-3">
					<input {...register("confirmPassword")} type="password" placeholder="Confirm password" className="w-full border rounded-md p-2" />
				</div>
				...
				{/* Submit button */}
				<div className="mt-3">
					<button className="p-2 px-4 bg-blue-400 rounded-md hover:bg-blue-500 text-white w-full">Register</button>
				</div>
			</form>
		</div>
	);
